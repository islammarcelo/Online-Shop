    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                totalPriceTxt.setText("Total Price = " + String.valueOf(overTotalPrice) + "$");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder cartViewHolder, int i, @NonNull final Cart cart) {
                cartViewHolder.productNameTxt.setText(cart.getPname());
                cartViewHolder.productPriceTxt.setText("Price = " +cart.getPrice()+"$");
                cartViewHolder.productQuantityTxt.setText("Quantity = " +cart.getQuantity());

                int oneTypeProductTotalPrice = (Integer.valueOf(cart.getPrice())) * (Integer.valueOf(cart.getQuantity()));
                overTotalPrice+= oneTypeProductTotalPrice;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (shippingState.equals("shipped")){
                        ...
                        totalPriceTxt.setText("Shipping State = Not Shipped");
                        recyclerView.setVisibility(View.GONE);//------?
                        txtMsg1.setVisibility(View.VISIBLE);
                        nextButton.setVisibility(View.GONE);
                        Toast.makeText(CartActivity.this, "you can purchase more products, once you received your first order.", Toast.LENGTH_SHORT).show();
